...
//TODO попробовать сделать некторые посты запросы без перезагрузки страницы и error alert(не факт)
//TODO добавить ссылку для восстановления пароля
//TODO сделать логаут пост запросом
//TODO смена пароля в профиле по email сделать
//TODO запретить /login и /register и account recovery если уже авторизован
